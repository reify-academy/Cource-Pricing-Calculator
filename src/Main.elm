...
import ProjectSlider exposing (hoursEstimates, viewHourEstimates)
...
type Msg
    ...
    | ProjectSlider ProjectSlider.Msg
...
update msg model =
    case msg of
        ...
        ProjectSlider sliderMsg ->
            case sliderMsg of
                ProjectSlider.HourEstimatesChanged selectedEstimate ->
...
view model =
    ...
    <|
        column [ width fill, spacingXY 0 20, paddingXY 50 0 ]
            ...
            , viewSessionsPerWeek model
            , viewTotalCost model
            , viewHourEstimates model.selectedEstimate hoursEstimates |> Element.map ProjectSlider
            ]
